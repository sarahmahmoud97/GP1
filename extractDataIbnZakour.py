...
poetryFile = codecs.open("C:\Users\Sarah\Downloads\IbnZakour.txt",encoding="utf8")
...
i = 1
pathO= r"D:\GraduationProject1\datasets\arabicPoetries\Ibn Zakour\train"
os.chdir(pathO)
...
#**************************************************************************
poetryFile = codecs.open("C:\Users\Sarah\Downloads\IbnZakourTest.txt",encoding="utf8")
testList = poetryFile.read().splitlines()
pathO= r"D:\GraduationProject1\datasets\arabicPoetries\Ibn Zakour\test"
os.chdir(pathO)
