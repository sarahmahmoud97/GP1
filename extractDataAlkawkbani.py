...
poetryFile = codecs.open("C:\Users\Sarah\Downloads\kawkabaniTrain.txt",encoding="utf8")
...
i = 1
pathO= r"D:\GraduationProject1\datasets\arabicPoetries\Alkawkabani\train"
os.chdir(pathO)
...
#**************************************************************************
poetryFile = codecs.open("C:\Users\Sarah\Downloads\kawkabaniTest.txt",encoding="utf8")
testList = poetryFile.read().splitlines()
pathO= r"D:\GraduationProject1\datasets\arabicPoetries\Alkawkabani\test"
os.chdir(pathO)
