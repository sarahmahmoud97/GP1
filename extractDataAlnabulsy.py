...
i = 1
pathO= r"D:\GraduationProject1\datasets\arabicPoetries\عبد الغني النابلسي\train"
os.chdir(pathO)
...
listTestData = ['',
               ...
               '',
               '',]
pathO= r"D:\GraduationProject1\datasets\arabicPoetries\عبد الغني النابلسي\test"
os.chdir(pathO)
