...
poetryFile = codecs.open("C:\Users\Sarah\Downloads\ManjakTrain.txt",encoding="utf8")
...
i = 1
pathO= r"D:\GraduationProject1\datasets\arabicPoetries\Manjak Basha\train"
os.chdir(pathO)
...
pathO= r"D:\GraduationProject1\datasets\arabicPoetries\Manjak Basha\test"
os.chdir(pathO)

poetryFile = codecs.open("C:\Users\Sarah\Downloads\ManjakTest.txt",encoding="utf8")
